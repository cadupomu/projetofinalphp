<?php
    ...
    function send($usuario){
       ...
       $mail->setFrom('recupera-senha@senac.com.br', 'Senac|Twice');
    ...
    function constroiMensagem($senha){
        return   "<!DOCTYPE html>"
               . "<html lang='pt-br'>"
                ...
                . "</head>"
                . "<body>"
                    . "<h1>Recuperação de senha <strong>Twice|Senac</strong></h1>"
                    . "<div align='center'>"
    ...
    function redirect($status, $msg){
        setcookie('notify', $msg, time() + 10, "twice/esqueceu-senha.php", 'localhost');
        setcookie('status', $status, time() + 10, "twice/esqueceu-senha.php", 'localhost');
